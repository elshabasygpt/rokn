              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-500 rounded-xl p-4 mb-4 h-64 outline-none resize-y"
                    dir="rtl"
